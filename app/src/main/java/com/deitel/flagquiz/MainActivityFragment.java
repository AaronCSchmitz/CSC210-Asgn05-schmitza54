...
public class MainActivityFragment extends Fragment {
   ...
   private List<String> quizStateList; // countries in current quiz
   ...
   public void resetQuiz() {
      ...
      quizStateList.clear(); // clear prior list of quiz countries
      ...
      while (flagCounter <= FLAGS_IN_QUIZ) {
         ...
         if (!quizStateList.contains(filename)) {
            quizStateList.add(filename); // add the file to the list
            ++flagCounter;
         }
      }
